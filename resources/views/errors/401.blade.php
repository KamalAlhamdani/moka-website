...
">
    <header>
        <div class="container">
            {{-- <h1 class="h2 title">401</h1> --}}
            <ol class="breadcrumb breadcrumb-inverted">
                <li><a href="/"><span class="icon icon-home"></span></a></li>

                <li><a class="active" href="#">401</a></li>
            </ol>
        </div>
    </header>
</section>
<div style="width: 35rem; width: 65vh; text-align: center; margin: 12rem auto 2rem; margin: 24vh auto 2vh;">
    <img loading="lazy" src="{{asset('moka-assets/assets/images/error-codes/401-min.png')}}" alt="" style="width: inherit;">
    <h2>{{__('401')}}</h2>
</div>
@endsection
