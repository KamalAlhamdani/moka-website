                ...
                <div class="row product-flex">
                    ...
                    <div class="col-md-4 col-sm-12 product-flex-info">
                        <div class="clearfix">
                            ...
                            <h1 class="title" data-title="{{ ''  }}">{{ $offers[$id]->name }}</h1>
                    ...
                    <div class="col-md-8 col-sm-12 product-flex-gallery">
                        ...
                        <form action="{{ route('web.cart.post') }}" method="post">
                            @csrf
                            <input type="hidden" name="id" value="{{ $offers[$id]->id }}">
                        ...
                        <div class="owl-product-gallery open-popup-gallery">
                            <a href="{{asset($offers[$id]->image_path)}}"><img loading="lazy" class="products-details" src="{{asset($offers[$id]->image_path)}}" alt="" height="500" onerror="this.src='{{asset('moka-assets/assets/images/defualt.png')}}'" /></a>
